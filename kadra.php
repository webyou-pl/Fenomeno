...
<section class="kadra">
    ...
    <div class="row">
        ...
        <a href="#" class="big-link" data-reveal-id="myModal1">    
            <img src="resources/img/kadra/bryan%20west.jpg"></a>
            <p>Imie Nazwisko</p>
        </div>
        <div id="myModal1" class="reveal-modal">
            <h6>Imie Nazwisko</h6>
            <img src="resources/img/kadra/trainer%20example.jpg" class="trainer-picture">
        ...
        <div class="col span-1-of-3 box">
            ...
            <img src="resources/img/kadra/donald%20evans.jpg"></a>
            <p>Imie Nazwisko</p>
            </div>
            <div id="myModal2" class="reveal-modal">
            <h6>Imie Nazwisko</h6>
            <img src="resources/img/kadra/treiner-exm2.jpg"class="trainer-picture">
            ...
            <img src="resources/img/kadra/eva%20wade.jpg"></a>
                <p>Imie Nazwisko</p>
            </div>
        ...
        <div class="trener2">
            ...
            <img src="resources/img/kadra/guy%20ferguson.jpg"></a>
                <p>Imie Nazwisko</p>
            </div>
            ...
            <img src="resources/img/kadra/sherry%20lee.jpg"></a>
            <p>Imie Nazwisko</p>
            </div>
